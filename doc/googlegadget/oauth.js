  <script type="text/javascript">
    ...
    // Called by fetchData() if user logged in
    ...
    function fetchData() {
      ...
      gadgets.io.makeRequest(url, function (response) {
        ...
        if (response.oauthApprovalUrl) {
          ...
          // Use the popup handler to attach onclick handlers to UI elements.  
          //The createOpenerOnClick() function returns an onclick handler to open the popup window.  
          //The createApprovedOnClick function returns an onclick handler that will close the popup window and attempt to fetch the user's data again.
          ...
          showOneSection('approval');
            ...
            // The response.oauthError and response.oauthErrorText values may help debug problems with your gadget.
